...
export const Hero = () => {
    return (
        <div className="bg-black text-white bg-[linear-gradient(to_bottom,#000,#200D42_34%,#4F21A1_65%,#A46EDB_82%)] py-18 sm:py-24 relative overflow-hidden">
            ...
            <div className="container relative">
                <div className="flex items-center justify-center">
                    <a href="#" className="inline-flex gap-3 border py-1 px-3 rounded-lg border-white/30">
                        ...
                        <span className="inline-flex items-center gap-2">
                            <span>Read More</span>
                            <Image src="/logos/logo.png" alt="Logo" width={20} height={20} />
                        </span>
                    </a>
                </div>
                ...
                <div className="flex justify-center mt-8">
                    <button className="bg-white text-black py-3 px-6 rounded-lg font-medium" aria-label="Download the app for free">
                        Get for free
                    </button>
                </div>
            </div>
