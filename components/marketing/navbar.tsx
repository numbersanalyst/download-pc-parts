      ...
      {isMenuOpen && (
        <div className="md:hidden bg-black border-t border-white border-opacity-10">
          <div className="flex flex-col px-4 py-2">
            <a href="#" className="text-white py-3 border-b border-white border-opacity-10">About</a>
            <a href="#" className="text-white py-3 border-b border-white border-opacity-10">Features</a>
            <a href="#" className="text-white py-3 border-b border-white border-opacity-10">Updates</a>
            <a href="#" className="text-white py-3 border-b border-white border-opacity-10">Help</a>
