  ...
  return (
    <div id="contact" className="bg-black text-white py-[72px] sm:py-24 text-center">
      <div className="container max-w-xl relative">
        ...
        <h2 className="font-bold text-5xl tracking-tighter sm:text-6xl">Contact with us</h2>
        ...
        <form className="mt-10 flex flex-col gap-2.5 max-w-sm mx-auto sm:flex-row">
          ...
          />
          <button className="bg-white text-black h-12 rounded-lg px-5 shrink-0">Contact</button>
        </form>
      </div>
    </div>
  );
